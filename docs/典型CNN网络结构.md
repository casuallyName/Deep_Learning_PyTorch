...
![image-20200229144708632](D:\Deep_Learning_PyTorch\docs\image\image-20200229144708632.png)
...
![image-20200229144729043](D:\Deep_Learning_PyTorch\docs\image\image-20200229144729043.png)
...
![image-20200229144820704](D:\Deep_Learning_PyTorch\docs\image\image-20200229144820704.png)

VGG块的组成规律是：连续使用数个相同的填充为1、窗口形状为3×3的卷积层后接上一个步幅为2、窗口形状为2×2的最大池化层。卷积层保持输入的高和宽不变，而池化层则对其减半。

# GoogleLeNet

![image-20200229144913169](D:\Deep_Learning_PyTorch\docs\image\image-20200229144913169.png)
...
![image-20200229144929818](D:\Deep_Learning_PyTorch\docs\image\image-20200229144929818.png)
